...
mod test {
    ...
    fn bad_hex() {
        ...
        assert_eq!(
            ...
            (
                2,
                make_error(bump, 0..2, 0, 0, ErrorKind::InvalidNumberLiteral)
            )
        );
    }
    ...
    fn bad_float_1() {
        ...
        assert_eq!(
            ...
            (
                3,
                make_error(bump, 0..3, 0, 0, ErrorKind::InvalidNumberLiteral)
            )
        );
    }
    ...
    fn bad_float_2() {
        ...
        assert_eq!(
            ...
            (
                5,
                make_error(bump, 0..5, 0, 0, ErrorKind::InvalidNumberLiteral)
            )
        );
    }
